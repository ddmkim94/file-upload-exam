...
import com.ll.exam.upload.app.home.controller.HomeController;
import com.ll.exam.upload.app.member.controller.MemberController;
...
class UploadApplicationTests {
	...
	void t3() throws Exception {
		...
		// GET /
		ResultActions resultActions = mvc
				.perform(get("/member/profile").with(user("user1").password("1234").roles("user")))
				.andDo(print());
	...
	void t4() throws Exception {
		...
		// GET /
		ResultActions resultActions = mvc
				.perform(get("/member/profile").with(user("user4").password("1234").roles("user")))
				.andDo(print());
